...
class CodegenLoader extends AssetLoader {
  ...
  //  "emirates": "هويه الإمارات",
    "note":"ملاحظة: يجب أن تكون بطاقة الهوية الإماراتية الخاصة بك و تاريخ الميلاد ورقم الهاتف المحمول مسجلة لدى المظلة",
  ...
  //  "mobile_number_required": "رقم الهاتف المحمول مطلوب",
   ...
   // "please_select_claim_type": "الرجاء تحديد نوع المطالبة",
    "select": "أختر",
     ...
     "reimbursement_claim_form": "استمارة مطالبة التعويض (معبأة وموقعة ومختومة من قبل الطبيب المعالج)",
    // "filled": "مملوء",
    // "signed_and": "وقعت و",
  ...
  "file_download":"اكتمل تنزيل الملف. يرجى التحقق من تطبيق الملفات.",
    "file_download_complete":"اكتمل تنزيل الملف. يرجى التحقق من مجلد التنزيلات.",
  ...
  "REGISTERUSER.INVALIDDOB": "تاريخ ميلاد غير صحيح",
    ...
    "REGISTERUSER.YEAROFBIRTHMISMATCH": "الجزء الثاني من حقل هوية الإمارات هو سنة ميلادك ولا يتطابق مع الجزء الموجود في حقل تاريخ الميلاد",
    "REGISTERUSER.INVALIDMOBILE": "رقم الجوال غير صحيح",
    "REGISTERUSER.NOTAVALIDUAEMOBILE": "جوال غير صالح (* يجب أن يبدأ الرقم بـ 971 ورقم يجب أن يكون 12)",
    "REGISTERUSER.NOTAVALIDMEMBER": "غير مسجل كعضو المظلة",
    "REGISTERUSER.USERNAMEEXISTS": "المستخدم موجود اصلا",
    "REGISTERUSER.USEREXISTS": "المستخدم موجود اصلا",
    ...
    "SAVEONLINECLAIM.NOTAVALIDMEMBER": "عضو غير صحيح",
    ...
    "SAVEONLINECLAIM.NOTAVALIDCLAIMATTACHMENT": "مرفق المطالبة الذي تم تحميله ليس بالتنسيق الصحيح",
    "SAVEONLINECLAIM.NOTAVALIDCLAIMATTACHMENTFILESIZE": "لا يمكن أن يكون حجم ملف مرفق المطالبة مساويًا لـ 0 بايت",
    "SAVEONLINECLAIM.INVALIDMEMBERBANKIBAN": "رقم الحساب المصرفي الدولي (IBAN) عضو غير صالح",
    "SAVEONLINECLAIM.INVALIDUSEMEMBERDEFAULTBANKACCOUNT": "طلب غير صالح",
    "SAVEONLINECLAIM.NOVALIDBANKACCOUNTFOUNDFORMEMBER": "لم يتم العثور على حساب مصرفي صالح للعضو",
    "SAVEONLINECLAIM.INVALIDMEMBERBANKACCOUNTNAME":"اسم حساب مصرفي عضو غير صالح",
    "SAVEONLINECLAIM.INVALIDBANKSWIFTCODE": "رمز سويفت الخاص بالأعضاء غير صالح",
    "SAVEONLINECLAIM.INVALIDMEMBERBANKSWIFTCODE":"رمز سويفت الخاص بالأعضاء غير صالح",
    "SAVEONLINECLAIM.INVALIDPAYMENTTYPE": "نوع الدفع غير صالح",
    "SAVEONLINECLAIM.INVALIDISRESUBMISSION": "طلب غير صالح",
    "SAVEONLINECLAIM.NOVALIDCLAIMSUBMISSIONFOUND":"لم يتم العثور على تقديم مطالبة صالح",
    "SAVEONLINECLAIM.INVALIDSUBMISSIONCLAIMREF": "تقديم مطالبة المرجع غير صالح",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT3FILESIZE": "لا يمكن أن يكون حجم ملف المرفق 3 الاختياري أكبر من 2 ميجابايت",
     // "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT3FILESIZE":"Optional Attachment3 file size cannot be equal to 0 Bytes",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT3":"المرفق الاختياري الذي تم تحميله 3 ليس بالتنسيق الصحيح",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT2FILESIZE": "لا يمكن أن يكون حجم ملف المرفق 2 الاختياري أكبر من 2 ميجابايت",

    // "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT2FILESIZE":"Optional Attachment2 file size cannot be equal to 0 Bytes",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT2": "المرفق 2 الاختياري الذي تم تحميله ليس بالتنسيق الصحيح",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT1FILESIZE": "لا يمكن أن يكون حجم ملف المرفق 1 الاختياري أكبر من 2 ميغا بايت",
    // "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT1FILESIZE":"Optional Attachment1 file size cannot be equal to 0 Bytes",
    "SAVEONLINECLAIM.NOTAVALIDOPTIONALATTACHMENT1": "المرفق الاختياري 1 الذي تم تحميله ليس بالتنسيق الصحيح",
    ...
    // FORGOTUSERNAME
    "FORGOTUSERNAME.INVALIDMEMBEREMIRATESIDNO": "رقم الهوية الإماراتية غير صالح",
    "FORGOTUSERNAME.INVALIDREGISTEREDEMAIL": "البريد الإلكتروني المسجل غير صالح",
    "FORGOTUSERNAME.NOVALIDUSERFOUND": "لم يتم العثور على مستخدم صالح",

    // FORGOTPASSWORD
    "FORGOTPASSWORD.INVALIDUSERNAME": "اسم مستخدم غير صحيح",
    "FORGOTPASSWORD.INVALIDREGISTEREDEMAIL": "البريد الإلكتروني المسجل غير صالح",
    ...
    "SAVECONTACTREASONDETAILS.INVALIDCONTACTREASONKEY": "مفتاح سبب الاتصال غير صالح",
    ...
    "UPDATEPASSWORD.MINIMUMLENGTHISSUE": "يجب أن يكون الحد الأدنى لطول كلمة المرور 6 على الأقل",
  ...
  static const Map<String, dynamic> en = {
   ...
   // "select_payer": "Select Payer",
    ...
    "note": "Note:Your Emirates ID,DOB and Mobile Number has to be registered with Almadallah",
    ...
    "select": "Select",
     "reimbursement_claim_form": "Reimbursement claim form(filled,signed,and stamped by the treating physician)",
    // "filled": "filled,",
  ...
  "file_download_complete":"File Download Complete. Please check in Downloads folder.",
    ...
    "REGISTERUSER.INVALIDMEMBEREMIRATESIDNO": "Invalid Member EmiratesIDNo",
    "REGISTERUSER.INVALIDMEMBEREMIRATESIDNOLENGTH":"Invalid Member EmiratesIDNo Length",
    ...
    "REGISTERUSER.NOTAVALIDMEMBER": "Not a valid Almadallah Member",
    "REGISTERUSER.USERNAMEEXISTS": "Username already exists",
    "REGISTERUSER.USEREXISTS": "User already exists",
    ...
    "SAVEONLINECLAIM.NOTAVALIDMEMBER": "Not a valid Member",
...
//UpdatePassword
    ...
    //GetDownloadableFileList
  "GETDOWNLOADABLEFILELIST.MISSINGMANDATORYFIELDS": "Missing Mandatory fields",
