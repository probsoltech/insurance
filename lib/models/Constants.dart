class Constants {
  static String Username = "testmember1";
  static String Password = "test1212";
  static String Base_Url = "https://services.almadallah.ae:8080";  //Live system
  //static String Base_Url = "https://services.almadallah.ae:8081";  //Test system
  //static String BankDetail = Base_Url + "/user/bankaccountdetails";  //same as BankAccountsUrl
  ...
  static String MemberUtilizationsUrl = Base_Url + "/member/memberutilizationdetails";
  ...
  static String ProviderSpecialitiesUrl = Base_Url + "/common/providerspecialities";
  ...
  static String GooglePlaceFromTextUrl = "https://maps.googleapis.com/maps/api/place/findplacefromtext/json"; 
  static String GoogleAPIKey = "AIzaSyAnvPokOJJ0iBCJJv4FpWcvEQDIwoGdJDw"; 
  static String MemberContractPeriodUrl = Base_Url + "/member/membercontractperiod"; 
  ...
  static String GoogleNearByPlacesUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json"; 
  static String GoogleGeolocationUrl = "https://www.googleapis.com/geolocation/v1/geolocate"; 
  static String GoogleGeocodingUrl = "https://maps.googleapis.com/maps/api/geocode/json";
  ...
  static String OneSignalPushNotificationAppID = '7249e1e9-b7ff-4131-806c-4fc6079b1630';
  static String PushNotificationRegistrationUrl = Base_Url + "/member/savepushnotificationregistrationdetails";
  static String PushNotificationsDetailsForUserUrl = Base_Url + "/user/showNotificationDetails";
}
